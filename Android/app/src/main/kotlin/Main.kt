...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        PhotoExhibitionAppDelegate.shared.onStart(this)
    }

    override fun onResume() {
        super.onResume()
        PhotoExhibitionAppDelegate.shared.onResume(this)
    }

    override fun onPause() {
        super.onPause()
        PhotoExhibitionAppDelegate.shared.onPause(this)
    }

    override fun onStop() {
        super.onStop()
        PhotoExhibitionAppDelegate.shared.onStop(this)
    }

    override fun onDestroy() {
        super.onDestroy()
        PhotoExhibitionAppDelegate.shared.onDestroy(this)
    }

    override fun onLowMemory() {
        super.onLowMemory()
        PhotoExhibitionAppDelegate.shared.onLowMemory(this)
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            PhotoExhibitionRootView().Compose(context = contentContext)
        }
    }
}
