...
fileprivate let logger: Logger = Logger(subsystem: "me.fromkk.PhotoExhibition", category: "PhotoExhibition")
...
public class PhotoExhibitionAppDelegate: ObservableObject {
